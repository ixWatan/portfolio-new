              ...
              <div className={classNames('app__page', `app__page--${status}`)}>
                <Suspense fallback={<Fragment />}>
                  <Switch location={location}>
                    ...
                    <Route path="/projects/recorderr" component={ProjectSPR} />
                    <Route path="/projects/game" component={ProjectSlice} />
                    <Route path="/projects/listivo" component={ProjectVolkihar} />
