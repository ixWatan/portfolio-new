...
import sliceBackground from 'assets/slice-background.jpg.png';
import sliceBackgroundLarge from 'assets/slice-background-large.jpg.png';
...
const title = '3D Relastic Game';
const description =
  'This project is gonna be big, Although it is too much complicated for my small brain, but I think Ima figure it out, Wait for the best!';
const roles = ['C#', 'Unity', 'Graphics Design'];
